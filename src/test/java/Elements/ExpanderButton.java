...
/**
 * This class is used to interact with buttons that can collapse or expand certain sections of a screen.
 *
 * Your selenium locator should uniquely match one of the following elements from the examples in this class' code.
 * Structure #1 - Element: <div id="example-id" class="hp-collapsible">
 * Structure #2 - Element: <a id="example-id" class="ssmc-super-expand-control">...</a>
 *
 * Created by stauffel on 6/18/14.
 */
public class ExpanderButton extends BaseElement {
     ...
     */
    public ExpanderButton (By locator) {
        super(locator);
        return;
    }
